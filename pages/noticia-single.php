	...
	<div class="center">
		...
		<?php if (Painel::logado() == false) { ?>
			<div class="container-erro-login">
				<p>Você precisa estar logado para comentar. Clique <a href="<?php echo INCLUDE_PATH ?>painel">aqui</a> para
					efetuar o login.</p>
			</div>
		<?php } else { ?>
			<?php
			...
			?>
			<h2 class="postar-comentario">Faça um comentário <i class="fa-solid fa-comment"></i></h2>
			<form method="post">
				...
				<input type="submit" value="Comentar" name="postar_comentario">
			</form>
			<br>
			<h2 class="postar-comentario">Comentários da Notícia <i class="fa-solid fa-comment"></i></h2>
			<?php
			...
			<div class="box-coment-noticia">
				...
				<form method="post">
					...
					<input type="submit" value="Responder" name="resposta_comentario">
				</form>
			</div>
			<?php } ?>
		<?php } ?>
