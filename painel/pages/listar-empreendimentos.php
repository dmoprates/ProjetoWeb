				...
				<div style="border: 1px solid #ccc;padding:8px 15px;height: 100%;">
					...
					<div style="width: 70%;float: left;border: 0;" class="box-single">
						<div class="body-box">
							...
							<div class="group-btn">
								<a class="btn delete"
									href="<?php echo INCLUDE_PATH_PAINEL ?>listar-empreendimentos?deletar=<?php echo $value['id']; ?>"><i
										class="fa fa-times"></i> Excluir</a>
								<a style="background: #0091ea" class="btn"
									href="<?php echo INCLUDE_PATH_PAINEL ?>visualizar-empreendimento/<?php echo $value['id']; ?>"><i
