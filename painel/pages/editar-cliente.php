...
<div class="box-content">
    ...
    <form class="ajax" atualizar method="post" action="<?php echo INCLUDE_PATH_PAINEL ?>ajax/forms.php"
        ...
        <div class="form-group">
            ...
            <select name="tipo_cliente">
                <option <?php if ($cliente['tipo_cliente'] == 'fisico')
                    echo 'selected'; ?> value="fisico">Fisico</option>
                <option <?php if ($cliente['tipo_cliente'] == 'juridico')
                    echo 'selected'; ?> value="juridico">Jurídico
                </option>
            </select>
        </div><!--form-group-->
    ...
    <h2><i class="fa-solid fa-money-check-dollar"></i> Adicionar Pagamentos</h2>
    ...
    ?>
    <h2><i class="fa-solid fa-money-bill-transfer"></i> Pagamentos Pendentes</h2>
        ...
        <table>
            ...
            foreach ($pendentes as $key => $value) {
                ...
                <tr <?php echo $style; ?>>
                    ...
                    <td><a class="btn edit" href="<?php echo INCLUDE_PATH_PAINEL ?>"><i class="fa fa-envelope"
                                aria-hidden="true"></i> E-mail</a></td>
                    <td><a style="background: #f7b830ff;" class="btn"
                            href="<?php echo INCLUDE_PATH_PAINEL ?>editar-cliente?id=<?php echo $id; ?>&pago=<?php echo $value['id'] ?>"><i
                                class="fa fa-check"></i> Pago</a></td>
                </tr>
