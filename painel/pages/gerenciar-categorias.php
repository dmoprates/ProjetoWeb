...
<div class="box-content">
	<h2 class="title"><i class="fa-solid fa-list"></i> Categorias Cadastrados</h2>
	...
	<table>
		...
		<tr>
			...
			<td><a class="btn edit" href="<?php echo INCLUDE_PATH_PAINEL ?>editar-categorias?id=<?php echo $value['id']; ?>"><i class="fa fa-pencil"></i> Editar</a></td>
