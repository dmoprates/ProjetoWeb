...
if (isset($_GET['pendentes']) == false) {
                        ...
                        <div style="width: 100%;float: left;" class="box-imgs">
                            ...
                            <?php } else { ?>
                                <img class="img-square"
                                    src="<?php echo INCLUDE_PATH_PAINEL ?>uploads/<?php echo $imagemSingle ?>" />
                            <?php } ?>
                        </div><!--box-imgs-->
                            ...
                            <div class="body-box">
                                ...
                                <div style="padding:8px 0;border-bottom: 1px solid #ccc;" class="group-btn">
                                    <form method="post" style="margin: 0;">
                                        ...
                                        <input type="number" name="quantidade" min="0" max="900" step="1"
                                ...
                                <div class="group-btn">
                                    <a class="btn delete"
                                        href="<?php echo INCLUDE_PATH_PAINEL ?>visualizar-produtos?deletar=<?php echo $value['id']; ?>"><i
                                            class="fa fa-times"></i> Excluir</a>
                                    <a class="btn edit"
                                        href="<?php echo INCLUDE_PATH_PAINEL ?>editar-produto?id=<?php echo $value['id'] ?>"><i
    ...
    <?php } else { ?>
        <div class="box-content">
            <h2><i class="fa fa-id-card-o" aria-hidden="true"></i> <a
                    href="<?php echo INCLUDE_PATH_PAINEL ?>visualizar-produtos">Produtos no estoque</a> » Produtos em falta
            </h2>
            <?php
            if (isset($_POST['atualizar'])) {
                $quantidade = $_POST['quantidade'];
                        ...
                        <div style="border: 1px solid #ccc;height: 100%;">
                            ...
                            <div style="width: 70%;float: left;border: 0;" class="box-single">
                                <div class="body-box">
                                    ...
                                    <p><b><i class="fa fa-pencil"></i> Largura:</b> <?php echo $value['largura'] ?>cm</p>
                                    <p><b><i class="fa fa-pencil"></i> Altura:</b> <?php echo $value['altura'] ?>cm</p>
                                    <p><b><i class="fa fa-pencil"></i> Comprimento:</b> <?php echo $value['comprimento'] ?>cm
                                    </p>
                                    <p><b><i class="fa fa-pencil"></i> Peso:</b> <?php echo $value['peso'] ?></p>
                                    <div style="padding:8px 0;border-bottom: 1px solid #ccc;" class="group-btn">
                                        <form method="post" style="margin: 0;">
                                            ...
                                            <input type="number" name="quantidade" min="0" max="900" step="1"
                                                value="<?php echo $value['quantidade'] ?>">
                                            <input type="hidden" name="produto_id" value="<?php echo $value['id']; ?>">
                                            <input style="background: #0091ea;" type="submit" name="atualizar"
                                                value="Atualizar!">
                                        </form>
                                    </div><!--group-btn-->
                                    <div class="group-btn">
                                        <a class="btn delete" item_id="<?php echo $value['id'] ?>"
                                            href="<?php echo INCLUDE_PATH_PAINEL ?>"><i class="fa fa-times"></i> Excluir</a>
                                        <a class="btn edit"
                                            href="<?php echo INCLUDE_PATH_PAINEL ?>editar-produto?id=<?php echo $value['id'] ?>"><i
                                                class="fa fa-pencil"></i> Editar</a>
                                    </div><!--group-btn-->
