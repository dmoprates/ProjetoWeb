...
<div class="box-content">
	<h2 class="title"><i class="fa fa-id-card-o" aria-hidden="true"></i> Depoimentos Cadastrados</h2>
	...
	<table>
		...
		<tr>
                    ...
                    <td><a class="btn edit" href="<?php echo INCLUDE_PATH_PAINEL ?>editar-depoimento?id=<?php echo $value['id']; ?>"><i class="fa-solid fa-pen-to-square"></i> Editar</a></td>
